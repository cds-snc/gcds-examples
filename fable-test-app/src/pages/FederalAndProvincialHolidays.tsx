...
// Components (internal)
import { DateModified, Heading, StyledLink, Text } from '../components';

const FederalAndProvincialHolidays: React.FC = () => {
  return (
    <section>
      ...
      <Text>You can check here for <StyledLink href="https://www.canada.ca/en/services/jobs/workplace/federally-regulated-industries.html" external>the full list</StyledLink>.</Text>
